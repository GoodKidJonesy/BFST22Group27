...
public class Range {
    ...
    public double getLeft(){
      if (debug) return topLeft.getX() + (getWidth() / 4); 
      return topLeft.getX(); 
    }
    public double getTop(){
      if (debug) return topLeft.getY() + (getHeight() / 4); 
      return topLeft.getY();
    }
    public double getRight(){
      if (debug) return bottomRight.getX() - (getWidth() / 4); 
      return bottomRight.getX(); 
    }
    public double getBottom(){
      if (debug) return bottomRight.getY() - (getHeight() / 4); 
